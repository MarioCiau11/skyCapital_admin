{{-- modal clientes --}}
<div class="modal fade" id="modalTableCuentas">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-md-4 p-lg-5">
                    ...
                    <div class="col-lg-12">
                        <div class=" table-responsive">
                            <div class="datatable-container">
                                <table class="table table-striped table-bordered widthAll datatable" id="tablaCuentasSelect">
                                    <thead>
                                        <tr>
                                            <th>Clave</th>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-dismiss="modal" id="btnAddCuenta">Agregar</button>
                </div>
            </div>
        </div>
    </div>
