        ...
        <div class="row">
            <div class="col-lg-10 col-md-10 col-xs-10">
                <div class="nk-block-text">
                    <h2 class="title">Información de Módulos</h2>
                </div>
            </div>
        </div>
        @php
                        ...
                        <div class="menu-sub menu-drop menu-mega ">
                            <div class="menu-mega-innr">
                                <ul class="menu-mega-list" id="shCol" style="z-index:1000;">
                                    ...
                                    <li>
                                        <div class="ckbox ckbox-primary">
                                            {!! Form::checkbox('Artículo', '2', true, ['id' => 'checkArtículo']) !!}
                                            {!! Form::label('checkArtículo', 'Artículo ', ['class' => 'negrita']) !!}
                                        </div>
                                    </li>
                                    <li>
                                        <div class="ckbox ckbox-primary">
                                            {!! Form::checkbox('Unidad', '3', false, ['id' => 'checkUnidad']) !!}
                                            {!! Form::label('checkUnidad', 'Unidad', ['class' => 'negrita']) !!}
                                        </div>
                                    </li>
                                    <li>
                                        <div class="ckbox ckbox-primary">
                                            {!! Form::checkbox('Usuario', '4', false, ['id' => 'checkUsuario']) !!}
                                    ...
                                    <li>
                                        <div class="ckbox ckbox-primary">
                                            {!! Form::checkbox('Proyecto', '8', true, ['id' => 'checkProyecto']) !!}
                                            {!! Form::label('checkProyecto', 'Proyecto', ['class' => 'negrita']) !!}
                                        </div>
                                    </li>
                                    <li>
                                        <div class="ckbox ckbox-primary">
                                            {!! Form::checkbox('Sucursal', '9', false, ['id' => 'checkSucursal']) !!}
                            ...
                            <tbody>
                                @if (session()->has('reportes_filtro'))
                                    @foreach (session('reportes_filtro') as $articulo)
                                        @include('include.reports.reportVentaItem')
                                    @endforeach
                                @else
