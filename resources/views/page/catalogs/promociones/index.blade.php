    ...
    <section class="bg-white">
        <div class="row">
            ...
            <div class="col-lg-2 col-sm-12 float-left">
                <a href="{{ route('cat.promociones.create') }}" class="btn btn-outline btn-sm btn-success float-left">Crear
                    promoción</a>
            </div>
        </div>
        ...
        {!! Form::open(['route' => 'cat.promociones.filtro', 'method' => 'POST']) !!}
        <div class="row row row-cols-1 row-cols-sm-2 row-cols-md-4">
            ...
            <div class="col-lg-12 ">
                <div class="botonesM">
                <a href="{{ route('cat.promociones.index') }}" type="reset"
                ...
                <div class=" table-responsive">
                    <div class="datatable-container">
                        <table class="table table-striped table-bordered widthAll datatable" id="shTable">
                            ...
                            <tbody>
                                @if (session()->has('promociones_filtro'))
                                
                                    @foreach (session('promociones_filtro') as $promocion)
                                        @include('include.catalogs.promocionesItem')
                                    @endforeach
                                @else
