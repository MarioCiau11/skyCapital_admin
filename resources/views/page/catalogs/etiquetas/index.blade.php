    ...
    <section class="bg-white">
        <div class="row">
            ...
            <div class="col-lg-2 col-sm-12 float-left">
                <a href="{{ route('cat.etiquetas.create') }}" class="btn btn-outline btn-sm btn-success float-left">Crear
                    Etiqueta</a>
            </div>
        </div>
        ...
        {!! Form::open(['route' => 'cat.etiquetas.filtro', 'method' => 'POST']) !!}
        <div class="row row row-cols-1 row-cols-sm-2 row-cols-md-4">
            ...
            <div class="col-lg-12">
                <div class="botonesM">
                <a href="{{ route('cat.etiquetas.index') }}" type="reset"
                ...
                <div class=" table-responsive">
                    <div class="datatable-container">
                        <table class="table table-striped table-bordered widthAll datatable" id="shTable">
                            ...
                            <tbody>
                                @if (session()->has('etiquetas_filtro'))
                                
                                    @foreach (session('etiquetas_filtro') as $etiqueta)
                                        @include('include.catalogs.etiquetasItem')
                                    @endforeach
                                @else
