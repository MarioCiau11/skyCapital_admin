...
<main class="ath-body">
    <section class="bg-white">
        ...
        <form action="{{route('agrup.articulos.categoria.store')}}" class="form-validate createForm" method="post" id="form-create">
            @csrf
            @include('page.agrup.Articulos.categoria.form')
