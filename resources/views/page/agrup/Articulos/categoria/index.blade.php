    ...
    <section class="bg-white">
        ...
        <div class="col-lg-8">
            <div class="nk-block-text">
                <h2 class="title">Categorías de Artículos</h2>
            </div>
        </div>
        <div class="col-lg-4 float-left">
            <a href="{{route("agrup.articulos.categoria.create")}}" class="btn btn-outline btn-sm btn-success float-left">Crear categoría</a>
                    ...
                    <table class="table table-striped table-bordered widthAll datatable" id="shTable">
                        ...
                        <tbody>
                            @foreach ($Categoria as $categorias)
                                @include('include.agrup.articulos.categoriaItem')
                            @endforeach
                        </tbody>
                    </table>
                </div>
