...
class ProyectosCategoriaController extends Controller
{
    private $categoriaBD;
    public $mensaje;
    public $status;
    ...
    {
        $categoria = AGRUP_CATEGORIA::where('catalogo','Proyectos')->get();
        return view('page.agrup.Proyectos.categoria.index',[
            'Categoria' => $categoria
        ]);
    }
    ...
    {
        return view('page.agrup.Proyectos.categoria.create',[
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()
            ->route('agrup.proyectos.categoria.index')
    ...
    public function edit(string $id)
    {
        ...
        return view('page.agrup.Proyectos.categoria.edit',[
            'Categoria' => $categoria
        ]);
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect()->route('agrup.proyectos.categoria.index')
                ->with('message', $message)
                ->with('status', $status);
        } catch (\Throwable $th) {
            return redirect()->route('agrup.proyectos.categoria.index')
