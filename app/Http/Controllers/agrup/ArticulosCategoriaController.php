...
class ArticulosCategoriaController extends Controller
{
    private $categoriaBD;
    public $mensaje;
    public $status;
    ...
    {
        $categoria = AGRUP_CATEGORIA::where('catalogo','Articulos')->get();
        return view('page.agrup.Articulos.categoria.index',[
            'Categoria' => $categoria
        ]);
    }
    ...
    {
        return view('page.agrup.Articulos.categoria.create',[
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()
            ->route('agrup.articulos.categoria.index')
    ...
    public function edit(string $id)
    {
        ...
        return view('page.agrup.Articulos.categoria.edit',[
            'Categoria' => $categoria
        ]);
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect()->route('agrup.articulos.categoria.index')
                ->with('message', $message)
                ->with('status', $status);
        } catch (\Throwable $th) {
            return redirect()->route('agrup.articulos.categoria.index')
