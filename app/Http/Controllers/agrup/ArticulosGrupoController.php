...
class ArticulosGrupoController extends Controller
{
    private $grupoBD;
    public $mensaje;
    public $status;
    ...
    {
        $grupo = AGRUP_GRUPO::where('catalogo','Articulos')->get();
        return view('page.agrup.Articulos.grupo.index',[
            'Grupo' => $grupo
        ]);
    }
    ...
    {
        return view('page.agrup.Articulos.grupo.create',[
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()
            ->route('agrup.articulos.grupo.index')
    ...
    public function edit(string $id)
    {
        ...
        return view('page.agrup.Articulos.grupo.edit',[
            'Grupo' => $grupo
        ]);
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect()->route('agrup.articulos.grupo.index')
                ->with('message', $message)
                ->with('status', $status);
        } catch (\Throwable $th) {
            return redirect()->route('agrup.articulos.grupo.index')
