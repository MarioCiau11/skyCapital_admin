...
class ProyectosGrupoController extends Controller
{
    ...
    {
        $grupo = AGRUP_GRUPO::where('catalogo','Proyectos')->get();
        return view('page.agrup.Proyectos.grupo.index',[
            'Grupo' => $grupo
        ]);
    }
    ...
    {
        return view('page.agrup.Proyectos.grupo.create',[
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()
            ->route('agrup.proyectos.grupo.index')
    ...
    public function edit(string $id)
    {
        ...
        return view('page.agrup.Proyectos.grupo.edit',[
            'Grupo' => $grupo
        ]);
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect()->route('agrup.proyectos.grupo.index')
                ->with('message', $message)
                ->with('status', $status);
        } catch (\Throwable $th) {
            return redirect()->route('agrup.proyectos.grupo.index')
